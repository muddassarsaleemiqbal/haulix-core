...
namespace PHPSTORM_META {
    ...
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
        \Illuminate\Bus\BatchRepository::class => \Illuminate\Bus\DatabaseBatchRepository::class,
        \Illuminate\Contracts\Auth\Access\Gate::class => \Illuminate\Auth\Access\Gate::class,
        \Illuminate\Contracts\Auth\StatefulGuard::class => \Illuminate\Auth\SessionGuard::class,
        \Illuminate\Contracts\Broadcasting\Broadcaster::class => \Illuminate\Broadcasting\Broadcasters\LogBroadcaster::class,
        \Illuminate\Contracts\Console\Kernel::class => \Illuminate\Foundation\Console\Kernel::class,
        \Illuminate\Contracts\Database\ConcurrencyErrorDetector::class => \Illuminate\Database\ConcurrencyErrorDetector::class,
        \Illuminate\Contracts\Database\LostConnectionDetector::class => \Illuminate\Database\LostConnectionDetector::class,
        \Illuminate\Contracts\Debug\ExceptionHandler::class => \NunoMaduro\Collision\Adapters\Laravel\ExceptionHandler::class,
        \Illuminate\Contracts\Foundation\MaintenanceMode::class => \Illuminate\Foundation\FileBasedMaintenanceMode::class,
        \Illuminate\Contracts\Http\Kernel::class => \Illuminate\Foundation\Http\Kernel::class,
        \Illuminate\Contracts\Log\ContextLogProcessor::class => \Illuminate\Log\Context\ContextLogProcessor::class,
        \Illuminate\Contracts\Pipeline\Hub::class => \Illuminate\Pipeline\Hub::class,
        \Illuminate\Contracts\Queue\EntityResolver::class => \Illuminate\Database\Eloquent\QueueEntityResolver::class,
        \Illuminate\Contracts\Routing\ResponseFactory::class => \Illuminate\Routing\ResponseFactory::class,
        \Illuminate\Contracts\Validation\UncompromisedVerifier::class => \Illuminate\Validation\NotPwnedVerifier::class,
        \Illuminate\Routing\Contracts\CallableDispatcher::class => \Illuminate\Routing\CallableDispatcher::class,
        ...
        \Laravel\Fortify\Contracts\LockoutResponse::class => \Laravel\Fortify\Http\Responses\LockoutResponse::class,
        \Laravel\Fortify\Contracts\LoginResponse::class => \Laravel\Fortify\Http\Responses\LoginResponse::class,
        \Laravel\Fortify\Contracts\LoginViewResponse::class => \Laravel\Fortify\Http\Responses\SimpleViewResponse::class,
        \Laravel\Fortify\Contracts\LogoutResponse::class => \Laravel\Fortify\Http\Responses\LogoutResponse::class,
        \Laravel\Fortify\Contracts\PasswordConfirmedResponse::class => \Laravel\Fortify\Http\Responses\PasswordConfirmedResponse::class,
        \Laravel\Fortify\Contracts\PasswordUpdateResponse::class => \Laravel\Fortify\Http\Responses\PasswordUpdateResponse::class,
        \Laravel\Fortify\Contracts\ProfileInformationUpdatedResponse::class => \Laravel\Fortify\Http\Responses\ProfileInformationUpdatedResponse::class,
        \Laravel\Fortify\Contracts\RecoveryCodesGeneratedResponse::class => \Laravel\Fortify\Http\Responses\RecoveryCodesGeneratedResponse::class,
        \Laravel\Fortify\Contracts\RedirectsIfTwoFactorAuthenticatable::class => \Laravel\Fortify\Actions\RedirectIfTwoFactorAuthenticatable::class,
        \Laravel\Fortify\Contracts\RegisterResponse::class => \Laravel\Fortify\Http\Responses\RegisterResponse::class,
        ...
        \Laravel\Fortify\Contracts\TwoFactorDisabledResponse::class => \Laravel\Fortify\Http\Responses\TwoFactorDisabledResponse::class,
        \Laravel\Fortify\Contracts\TwoFactorEnabledResponse::class => \Laravel\Fortify\Http\Responses\TwoFactorEnabledResponse::class,
        \Laravel\Fortify\Contracts\TwoFactorLoginResponse::class => \Laravel\Fortify\Http\Responses\TwoFactorLoginResponse::class,
        \Laravel\Fortify\Contracts\VerifyEmailResponse::class => \Laravel\Fortify\Http\Responses\VerifyEmailResponse::class,
        \Laravel\Fortify\Contracts\VerifyEmailViewResponse::class => \Laravel\Fortify\Http\Responses\SimpleViewResponse::class,
    ...
    override(\Illuminate\Support\Facades\App::get(0), map([
        '' => '@',
        \Illuminate\Bus\BatchRepository::class => \Illuminate\Bus\DatabaseBatchRepository::class,
        \Illuminate\Contracts\Auth\Access\Gate::class => \Illuminate\Auth\Access\Gate::class,
        \Illuminate\Contracts\Auth\StatefulGuard::class => \Illuminate\Auth\SessionGuard::class,
    ...
    override(\Illuminate\Support\Facades\App::makeWith(0), map([
        '' => '@',
        \Illuminate\Bus\BatchRepository::class => \Illuminate\Bus\DatabaseBatchRepository::class,
        \Illuminate\Contracts\Auth\Access\Gate::class => \Illuminate\Auth\Access\Gate::class,
        \Illuminate\Contracts\Auth\StatefulGuard::class => \Illuminate\Auth\SessionGuard::class,
    ...
    override(config(), map([
        ...
        'filesystems.links.C:\Users\mudda\Herd\haulix-core\public\storage' => 'string',
    ...
    override((new \Illuminate\Foundation\Testing\Concerns\InteractsWithContainer())->mock(0), map(['' => "@&\Mockery\MockInterface"]));
    override((new \Illuminate\Foundation\Testing\Concerns\InteractsWithContainer())->partialMock(0), map(['' => "@&\Mockery\MockInterface"]));
    override((new \Illuminate\Foundation\Testing\Concerns\InteractsWithContainer())->instance(0), type(1));
    override((new \Illuminate\Foundation\Testing\Concerns\InteractsWithContainer())->spy(0), map(['' => "@&\Mockery\MockInterface"]));
    ...
    registerArgumentsSet('configs',
        ...
        'filesystems.disks.s3.throw', 'filesystems.disks.s3.report', 'filesystems.links.C:\\Users\\mudda\\Herd\\haulix-core\\public\\storage', 'fortify.guard', 'fortify.middleware',
    ...
    registerArgumentsSet('translations',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid', 'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
        'C:.Users.mudda.Herd.haulix-core.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name', );
    ...
    expectedArguments((new \Illuminate\Foundation\Auth\Access\Authorizable())->can(), 0, argumentsSet('auth'));
    expectedArguments((new \Illuminate\Foundation\Auth\Access\Authorizable())->cannot(), 0, argumentsSet('auth'));
    expectedArguments((new \Illuminate\Foundation\Auth\Access\Authorizable())->cant(), 0, argumentsSet('auth'));
    expectedArguments((new \Illuminate\Contracts\Auth\Access\Authorizable())->can(), 0, argumentsSet('auth'));
    ...
    expectedArguments((new \Illuminate\Contracts\Translation\Translator())->get(), 0, argumentsSet('translations'));
